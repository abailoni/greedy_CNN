...
path = '/mnt/data2/abailoni/cityscape/leftImg8bit/val/'
...
path = '/mnt/data2/abailoni/cityscape/gtFine/val/'
...
val_x = F.create_dataset("val_x_dset", (2975,3,CROP_SIZE[0], CROP_SIZE[1]),
dtype='uint8')
val_y = F.create_dataset("val_y_dset", (2975,CROP_SIZE[0], CROP_SIZE[1]), dtype='uint8')
