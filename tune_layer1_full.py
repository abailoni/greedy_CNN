...
decay_conv = 3.90961e-02 ## Increased a bit for the full layer
...
# Adjust convmax before to tune a new node (right after regression)
...
class tune_lrn_rate(tune_hyperparams):
    def fit_model(self, param_values, model_name):
        ...
        # preLoad = {
        #     'cnv_L0_G0': ('tuning/layer1_naive/model_706402/', False),
        #     'regr_L0G0N1': ('tuning/layer1_naive/model_706402/', False),
        #     'regr_L0G0N2': ('tuning/layer1_naive/model_706402/', False),
        #     'regr_L0G0N3': ('tuning/layer1_naive/model_706402/', False),
        #     'regr_L0G0N4': ('tuning/layer1_naive/model_706402/', False),
        # }
