...
class tune_lrn_rate(tune_hyperparams):
    def fit_model(self, param_values, model_name):
        ...
        # Set values:
        # ----------------------
        lrn_rate, filter_size = param_values['lrn_rate'], param_values['filter_size']
        ...
        convSoftmax_params['filter_size1'], convSoftmax_params['filter_size2'] = int(filter_size),int(filter_size)
        # ----------------------
        # Init and train net:
        # ----------------------
        greedy_routine = greedyRoutine(
...
first = tune_lrn_rate(
    (
        ('lrn_rate', 9.16196e-03, None, None, None),
        ('filter_size', 3, None, None, None)
    ),
